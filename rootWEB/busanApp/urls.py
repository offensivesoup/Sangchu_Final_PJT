...
from .views import service_population_json, service_population
...
from .views import service_population_json, service_population, store_density_json, store_density
